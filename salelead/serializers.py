...
class OnsiteRegistrationSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        request = self.context["request"]
        user = request.user
        assign_user = validated_data.pop("assign_to", None)
        final_owner = assign_user or user
        ...
        if opportunity:
            ...
            final_owner = assign_user if assign_user else user
        ...
        lead_kwargs = {
            ...
            # ✅ ownership — ALL synced
            "assign_to": final_owner,
            "current_owner": final_owner,
            "first_owner": final_owner,
